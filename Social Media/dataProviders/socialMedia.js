...
(function() {
    var provider = app.data.socialMedia = new Everlive({
            offlineStorage: true,
            appId: '19ew7gruq2zlg4z4',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'socialMedia_access_token',
...
// START_CUSTOM_CODE_socialMedia
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_socialMedia